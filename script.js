...
function showLeaderboard(){ 
  ...
  arr.slice(0,10).forEach(p=>{ const li=document.createElement('li'); li.innerText=`${p.username}: ${p.points} Punkte`; list.appendChild(li); });
}
...
// Hier Memory, Flashcards, Normal Learning wie vorher
// ...
// (Kann 1:1 aus meinem letzten Code übernommen werden, nur Wörter aus words.js nutzen)
